...
// Pseudo-random math using mixed sine/cosine to create organic, jagged heights
...
const NoticeBoard = () => {
  return (
    <section className="bg-primary flex justify-center items-center min-h-screen relative overflow-hidden z-0">
      ...
      {/* CSS FOR WIND SWAY AND CHALK FONT */}
      <style>
        {`
      ...
      {/* MASTER SCALING WRAPPER
          This acts as a fixed 1000x760 canvas. Instead of breaking layouts, 
          it scales the entire diorama down proportionally based on screen width. */}
      <div className="relative w-[1000px] h-[760px] flex flex-col items-center justify-start transform origin-center 
        ...
        {/* Stand/Pole (Deeply rooted into the rocks) */}
